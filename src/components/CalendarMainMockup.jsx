...
export default function Calendar({ jsonData, year, month }) {
    ...
    return(
        <div className="grid grid-cols-7 scale-90 gap-px bg-slate-200 dark:bg-gray-700 rounded-2xl overflow-hidden shadow-2xl max-w-6xl mx-auto border border-slate-200 dark:border-gray-700">
            {/* Cabecera Días */}
