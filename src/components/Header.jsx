...
export default function Header() {
    return (
        <div className="flex flex-row bg-gray-100 p-4 lg:px-15 items-center justify-between lg:sticky top-0 z-10 shadow-sm">
            <h1 className="text-xl lg:text-3xl font-bold text-primary">Better URJC Calendar</h1>
