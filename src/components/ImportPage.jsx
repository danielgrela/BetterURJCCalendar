        ...
        <div className='px-4 lg:px-0 min-h-full flex flex-col'>
            ...
            <div className='flex flex-col gap-4'>
                ...
                <label
                    ...
                    <p className="mt-1 text-sm text-gray-500">Formatos soportados: el archivo .xlsx original de <a href="https://servicios.urjc.es/examenes/" target="_blank" rel="noopener noreferrer" className="text-blue-700 hover:underline">examenes</a> </p>
                </label>
                ...
                <div className='flex flex-col gap-6'>
                    ...
                    <div className="text-sm text-secundario border border-gray-400 bg-gray-100 rounded-sm p-4 gap-4 flex flex-row">
                        ...
                        <div className='flex flex-col gap-2'>
                            ...
                            <p>Asegúrate de que el archivo contenga <NavLink to="dashboard/guia-de-uso" className="text-blue-700 hover:underline">las columnas necesarias </NavLink> y que los datos estén en el formato correcto.</p>
                        </div>
                    </div>
                </div>
